...
saveTrip = async (e) => {
    ...
    e.preventDefault();
    const {destination, departure_date, return_date, trip_completed, travelerid} = this.state
    console.log("this.state", this.state)
    try {
        const trip = await axios.post('/api/trips', {destination, departure_date, return_date, trip_completed, travelerid})
